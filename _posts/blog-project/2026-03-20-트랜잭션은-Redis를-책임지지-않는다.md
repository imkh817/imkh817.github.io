...
{% include bookmark.html url="https://imkh817.github.io/posts/blog-project/게시글과-댓글,-왜-굳이-분리했을까/" %}

이전 글에서는 조회수 증가 로직에서 발생할 수 있는 DB 부하를 줄이기 위해,  
Redis를 버퍼로 두고 일정 주기로 DB에 반영하는 구조를 적용했다.
1. 사용자가 게시글 조회 
