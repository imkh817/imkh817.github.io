---
title: "[동시성 편] GET과 DEL 사이, 그 사이 사라진 조회수"
date: 2026-03-01 19:09:21 +0900
series: "[블로그 프로젝트] Redis 버퍼 시스템: 동시성부터 트랜잭션까지"
categories: [blog-project, 트러블슈팅]
image:
  path: /assets/img/thumbnails/속마음.jpeg
---
...
{% include bookmark.html url="https://redis.io/docs/latest/commands/getdel/" %}

{% include bookmark.html url="https://docs.spring.io/spring-data/redis/docs/current/api/org/springframework/data/redis/core/ValueOperations.html" %}
